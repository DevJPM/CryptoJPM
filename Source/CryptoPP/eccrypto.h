...
template <class EC, class COFACTOR_OPTION = NoCofactorMultiplication, bool DHAES_MODE = false,class HASH = SHA1,class KDF = P1363_KDF2<HASH>>
struct ECIES
	: public DL_ES<
		DL_Keys_EC<EC>,
		DL_KeyAgreementAlgorithm_DH<typename EC::Point, COFACTOR_OPTION>,
		DL_KeyDerivationAlgorithm_P1363<typename EC::Point, DHAES_MODE, KDF >,
		DL_EncryptionAlgorithm_Xor<HMAC<HASH>, DHAES_MODE>,
		ECIES<EC> >
{
