...
class CRYPTOPP_DLL CRYPTOPP_NO_VTABLE PKCS1v21_SignateMessageEncodingMethod_Base : public PK_SignatureMessageEncodingMethod
{
public:
	static const char* CRYPTOPP_API StaticAlgorithmName() {return "EMSA-PSS";}

	size_t MinRepresentativeBitLength(size_t, size_t digestSize) const
		{return 16 * digestSize + 9;}
...
template<class MGF = P1363_MGF1>
class CRYPTOPP_DLL PKCS1v21_SignateMessageEncodingMethod : public PKCS1v21_SignateMessageEncodingMethod_Base
{
private:
...
template<class MGF = P1363_MGF1>
struct PKCS1v21 : public SignatureStandard
{
	typedef PKCS1v21_SignateMessageEncodingMethod<MGF> SignatureMessageEncodingMethod;
};
